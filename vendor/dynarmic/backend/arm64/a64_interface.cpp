...
struct Jit::Impl final {
    ...
    void SetTPIDRRO_EL0(std::uint64_t value) {
        if (conf.tpidrro_el0) *conf.tpidrro_el0 = value;
    }

    void SetTPIDR_EL0(std::uint64_t value) {
        if (conf.tpidr_el0) *conf.tpidr_el0 = value;
    }

    std::uint64_t GetTPIDR_EL0() const {
        return conf.tpidr_el0 ? *conf.tpidr_el0 : 0;
    }
...
void Jit::SetTPIDRRO_EL0(std::uint64_t value) {
    impl->SetTPIDRRO_EL0(value);
}

void Jit::SetTPIDR_EL0(std::uint64_t value) {
    impl->SetTPIDR_EL0(value);
}

std::uint64_t Jit::GetTPIDR_EL0() {
